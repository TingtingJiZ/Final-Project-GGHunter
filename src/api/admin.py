...
from .models import db, Users, Games, GamesCharacteristic, Plataforms, Favorites, SocialAccounts, Comments, Media, Store, Comparatives
...
def setup_admin(app):
    ...
    admin.add_view(ModelView(Comparatives, db.session))
